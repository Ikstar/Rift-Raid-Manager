...
class Auth extends Controller {
    ...
    function __construct() {
        ...
        $menu = new Menu;
        $this->data['menu'] = $menu->show_menu();
        $this->data['webtitle'] = "Raid Manager";
        $this->data['websubtitle'] = "Raid Manager Administration";
        $this->data['webfooter'] = ' Created by Ikstars.com';
    }
    ...
    function forgot_password() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->data['identity_human'] = $identity_human; //added
